...
(() => {
  document.addEventListener('DOMContentLoaded', () => {
    if (document.querySelector('[data-shell="navbar"]')) {
      ...
      nav.id = 'navbar';
      nav.innerHTML = `
        <a href="index.html" class="navbar__logo"><img src="logo.png" alt="Kiki Auto Srl" style="height:34px;width:auto;object-fit:contain;vertical-align:middle;margin-right:10px">KIKI <span>AUTO</span></a>
        ...
        <a href="https://wa.me/18096222328?text=Hola%2C%20escribo%20desde%20su%20sitio%20web%20%28https%3A%2F%2Fkikiauto.vercel.app%29%20y%20me%20gustar%C3%ADa%20conocer%20m%C3%A1s%20sobre%20los%20veh%C3%ADculos%20disponibles." class="navbar__cta" target="_blank" rel="noopener">
          <span>Contactar</span>
    ...
    if (document.querySelector('[data-shell="footer"]')) {
      ...
      f.innerHTML = `
        <div class="footer-cinema__top">
          <h3 class="footer-cinema__bigword">Kiki<br><em>Auto</em>.</h3>
          <a href="https://wa.me/18096222328?text=Hola%2C%20escribo%20desde%20su%20sitio%20web%20%28https%3A%2F%2Fkikiauto.vercel.app%29%20y%20me%20gustar%C3%ADa%20conocer%20m%C3%A1s%20sobre%20los%20veh%C3%ADculos%20disponibles." class="footer-cinema__cta" target="_blank" rel="noopener">
        ...
        <div class="footer-cinema__grid">
          ...
          <div>
            ...
            <ul>
              <li><a href="https://wa.me/18096222328?text=Hola%2C%20escribo%20desde%20su%20sitio%20web%20%28https%3A%2F%2Fkikiauto.vercel.app%29%20y%20me%20gustar%C3%ADa%20conocer%20m%C3%A1s%20sobre%20los%20veh%C3%ADculos%20disponibles." target="_blank" rel="noopener">+1 (809) 622-2328</a></li>
              <li><a href="mailto:contacto@kikiauto.do">contacto@kikiauto.do</a></li>
              <li>Villa Mella · D.N.</li>
            </ul>
          </div>
          <div>
        ...
        <div class="footer-cinema__bottom">
          <p>&copy; 2026 Kiki Auto Srl · Demo de referencia. Sitio no oficial.</p>
    ...
    if (!document.querySelector('.whatsapp-float')) {
      ...
      w.href = 'https://wa.me/18096222328?text=' + encodeURIComponent('Hola, escribo desde su sitio web (https://kikiauto.vercel.app) y me gustaría conocer más sobre los vehículos disponibles.');
      w.target = '_blank';
      w.rel = 'noopener';
